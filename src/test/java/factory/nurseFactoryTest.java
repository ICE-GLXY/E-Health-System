...
import Main.factory.nurseFactory;
...
class nurseFactoryTest {
    User user5 = new User.Builder().username("user5").name("name5").password("password5").cellPhoneNumber("238244").email("email5@gmail.com").userType("nurse").build();
